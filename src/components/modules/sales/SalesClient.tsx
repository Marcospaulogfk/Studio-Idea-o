...
import { Plus, X, ShoppingBag, DollarSign, TrendingUp, Filter } from 'lucide-react'
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        action={<Button onClick={()=>setShowForm(true)}><Plus size={16}/> Nova Venda</Button>}
      />
            ...
            <tbody className="divide-y divide-gray-50">
              ...
              {filtered.map(sale => (
                <tr key={sale.id} className="hover:bg-gray-50/50 transition-colors">
                  ...
                  <td className="px-4 py-3 text-xs text-gray-500">{formatDate(sale.sold_at)}</td>
                  <td className="px-4 py-3">
            ...
            <form onSubmit={handleCreate} className="p-6 space-y-4">
              ...
              <div className="border border-gray-200 rounded-xl p-4 space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <label htmlFor="has_package" className="text-sm font-medium text-gray-700">Incluir pacote de artes?</label>
                </div>
                {form.has_package && (
                  <div className="grid grid-cols-2 gap-4">
